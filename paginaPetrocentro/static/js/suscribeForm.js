var __subscribeFormEl_pp = document.getElementById('subscribeForm');
if (__subscribeFormEl_pp) {
    __subscribeFormEl_pp.addEventListener('submit', function(e) {
        e.preventDefault();
  ...
  .catch(error => {
    ...
    console.debug('subscribeForm no presente — paginaPetrocentro/suscribeForm.js no ha añadido listeners.');
}
